...
internal class AddressBookV1Serializer : AddressBookSerializer() {

    fun serializeAddressBook(outputStream: OutputStream, addressBook: AddressBook) {
    ...
    fun deserializeAddressBook(inputStream: InputStream): AddressBook {
        return AddressBook(
            ...
            contacts = inputStream.readInt().let { contactsSize ->
