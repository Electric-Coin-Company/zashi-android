...
@Composable
internal fun AddZashiABContactScreen(args: AddZashiABContactArgs) {
    val viewModel = koinViewModel<AddZashiABContactVM> { parametersOf(args) }
...
@Serializable
data class AddZashiABContactArgs(
    val address: String?
)
