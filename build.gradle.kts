...
tasks {
    ...
    register("checkProperties") {
        doLast {
            // Ensure that developers do not change default values of certain properties directly in the repo, but instead
            // set them in their local ~/.gradle/gradle.properties file (or use command line arguments)
