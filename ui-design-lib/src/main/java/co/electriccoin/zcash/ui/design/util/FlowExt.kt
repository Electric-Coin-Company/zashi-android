...
): Flow<R> = combine(flow, flow2, flow3, flow4, flow5, flow6, flow7, flow8, flow9, flow10) {
    transform(
        it[0] as T1,
        it[1] as T2,
        it[2] as T3,
...
): Flow<R> = combine(flow, flow2, flow3, flow4, flow5, flow6, flow7, flow8, flow9, flow10, flow11) {
    transform(
        it[0] as T1,
        it[1] as T2,
        it[2] as T3,
...
): Flow<R> = combine(flow, flow2, flow3, flow4, flow5, flow6, flow7, flow8, flow9, flow10, flow11, flow12) {
    transform(
        it[0] as T1,
        it[1] as T2,
        it[2] as T3,
