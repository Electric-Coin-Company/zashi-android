...
private val releaseNotesEnPath = file("${project.rootDir}/docs/whatsNew/WHATS_NEW_EN.md")
private val releaseNotesEsPath = file("${project.rootDir}/docs/whatsNew/WHATS_NEW_ES.md")
